...
void init_collisions(main_t *main_struct)
{
    ...
    main_struct->map[0] = get_collision("./ressources/maps/map_cols/sm1_cols.txt");
    main_struct->map[1] = get_collision("./ressources/maps/map_cols/corridor_cols.txt");
    main_struct->map[2] = get_collision("./ressources/maps/map_cols/ground_cols.txt");
}
